...
%\sectionx{25}
%
%\textbf{A partir de los gráficos de $ g(x) = \sen(x) $ y $ h(x) = \cos(x) $, haga el gráfico de: }
%
%\begin{enumerate}[(a)]
%
%\bfseries
...
%\subsectionx{25.a}
%
%Este es un caso de desplazamiento horizontal, porque se le está sumando o restando una constante al argumento de la función seno. Concretamente, se tiene un desplazamiento de $ \pi $ unidades hacia la derecha. Se deduce que es hacia la derecha porque el punto correspondiente a $x = 0$ pasa a estar en $x = \pi$, que está a la derecha. 
%
%\figurex{Ejercicio 25.a}{4}{../img/guide_01/ex_25a.png}{fig:25a}
%
%\subsectionx{25.b}
%
%En este caso, se tiene un escalamiento horizontal. Al multiplicar el argumento del coseno por 2, los puntos que estaban en $x = a$ ahora pasan a estar en $x = a/2$. Visualmente, es como si la curva se comprimiera horizontalmente por un factor de dos. Tratándose además de una función periódica, el período se reduce a la mitad y la frecuencia se duplica. El nuevo período es entonces $\pi$.
%
%\figurex{Ejercicio 25.b}{5}{../img/guide_01/ex_25b.png}{fig:25b}
%
%\subsectionx{25.c}
%
%Ahora hay dos tranformaciones combinadas: un escalado horizontal con un factor de 2, y un desplazamiento horizontal de $\pi$ unidades hacia la izquierda. En estos casos, hay que tener cuidado porque el orden en que se aplican las transformaciones importa: no es lo mismo escalar y desplazar que desplazar y escalar. En este caso, partiendo del gráfico de $ h(x) = \cos(x) $, lo correcto para llegar a $ f(x) = \cos(2x + \pi) $ es desplazar $\pi$ unidades hacia la izquierda primero, y escalar horizontalmente con un factor de 2 luego. Si se hace lo inverso, el cambio de escala horizontal introducido al escalar primero hace que el desplazamiento de $\pi$ unidades ya no sea válido. De hecho, siguiendo este camino se observa que el desplazamiento debería ser de $\frac{\pi}{2}$ unidades, lo cual tiene sentido por el cambio de escala previo.
%
%\figurex{Ejercicio 25.c}{5}{../img/guide_01/ex_25c.png}{fig:25c}
%
%Esto se ilustra en la figura~\ref{fig:25c} introduciendo el paso intermedio $ f_d(x) = \cos(x + \pi) $ en color naranja. Si primero se desplaza el coseno $\pi$ unidades hacia la izquierda y luego se escala, se llega al gráfico correcto.
%
%\subsectionx{25.d}
%
%Ahora sólo hay un desplazamiento horizontal de $\pi$ unidades hacia la izquierda. Nótese que esto coincide con el gráfico del coseno, lo cual es coherente con la conocida identidad $ \cos(x) = \sen\left(x + \frac{\pi}{2} \right) $.
%
%\figurex{Ejercicio 25.d}{5}{../img/guide_01/ex_25d.png}{fig:25d}
%
%\sectionx{26}
%
%\textbf{Determine todos los valores de $x \in \mathbb{R}$ tales que:}
%
%\begin{enumerate}[(a)]
%
%\bfseries
...
%
%\item $ \cos\left( x + \frac{\pi}{4} \right) = \frac{\sqrt{2}}{2} ( \cos(x) - \sen(x) ) $
%
%\end{enumerate}
%
%\hrule
...
%\subsectionx{26.a}
%
%Aplicando arco seno de ambos lados, se obtiene $ x = \frac{\pi}{6} $. A partir de este valor, se puede obtener otro dado por la simetría de la función seno:
%
%\begin{equation}
%\sen(x) = \sen( \pi - x ) \Rightarrow x = \frac{5}{6} \pi \text{ también es solución}
%\end{equation}
%
%Por otro lado, la función seno es $2\pi$-periódica. Por ende, estas dos soluciones deben replicarse al infinito en ambas direcciones, usando el período. Resulta entonces:
%
%\begin{subequations}
%\begin{align}
%\hresult{26.a - 1er conjunto}{ x = \frac{\pi}{6} + 2 k \pi, k \in \mathbb{Z} } \\
%\hresult{26.a - 2do conjunto}{ x = \frac{5}{6}\pi + 2 k \pi, k \in \mathbb{Z} }
%\end{align}
%\end{subequations}
%
%\subsectionx{26.b}
%
%El conjunto imagen de la función coseno está acotado al intervalo $[-1, 1]$. El valor $ \frac{3}{2} $ está fuera de ese intervalo, y por lo tanto esta ecuación no tiene solución en los números reales. Otra forma de verlo es intentar aplicar la función arco coseno de ambos lados: dado que dicha función tiene el conjunto dominio restringido al intervalo $[-1, 1]$, se llega a la misma conclusión al intentar evaluar $ \arccos\left( \frac{3}{2} \right) $.
%
%\subsectionx{26.c}
%
%Esta ecuación recuerda a la identidad $ \sin^2(x) + \cos^2(x) = 1 $. Para que esa expresión aparezca en el lado izquierdo, es posible sumar $2 \sin^2(x)$ miembro a miembro. Ello conduce a:
%
%\begin{subequations}
%\begin{align}
%& \cos^2(x) - \sin^2(x) + 2 \sin^2(x) = 1 + 2 \sin^2(x) \\
%& \underbrace{ \cos^2(x) + \sin^2(x) }_{1} = 1 + 2 \sin^2(x) \\
%& 1 - 1 = 2 \sin^2(x) \\
%& 0 = \sin^2(x) \\
%& 0 = |\sin(x)|
%\end{align}
%\end{subequations}
%
%Los ceros del seno cuadrado y del seno con módulo son los mismos que los del seno común, vale decir:
%
%\begin{equation}
%\hresult{26.c}{ x = k \pi, k \in \mathbb{Z} }
%\end{equation}
%
%\subsectionx{26.d}
%
%Esta es una identidad trigonométrica, y se cumple para todo valor de x.
%
%\begin{equation}
%\hresult{26.d}{ x \in \mathbb{R} }
%\end{equation}
%
%\subsectionx{26.e}
%
%Identidad a aplicar: seno de la suma.
%
%\begin{equation}
%\sin(a + b) = \sin(a) \cos(b) + \cos(a) \sin(b)
%\end{equation}
%
%Para este caso particular, $ a = x, b = x $.
%
%\begin{subequations}
%\begin{align}
...
%\end{subequations}
%
%Por lo tanto, esta ecuación es una identidad: se cumple para todo valor de x.
%
%\begin{equation}
%\hresult{26.e}{ x \in \mathbb{R} }
%\end{equation}
%
%\subsectionx{26.f}
%
%Identidad a aplicar: coseno de la suma.
%
%\begin{equation}
%\cos(a + b) = \cos(a) \cos(b) - \sin(a) \sin(b)
%\end{equation}
%
%Para este caso particular, $ a = x, b = \frac{\pi}{4} $.
%
%\begin{subequations}
%\begin{align}
%\cos\left( x + \frac{\pi}{4} \right) &= \cos(x) \underbrace{ \cos\left( \frac{\pi}{4} \right) }_{ \sqrt{2}/2 } - \sin(x) \underbrace{ \sin\left( \frac{\pi}{4} \right) }_{ \sqrt{2}/2 } \\
...
%
%\begin{equation}
%\hresult{26.f}{ x \in \mathbb{R} }
%\end{equation}
%
%\sectionx{27}
%
%\textbf{Haga el gráfico de las funciones inversas de $ g(x) = \sin(x) $ y $ h(x) = \cos(x) $. Determine los valores de $ x \in \mathbb{R} $ tales que:}
%
%\begin{enumerate}[(a)]
%
%\bfseries
...
%\end{table}
%
%Se observa que, al igual que la función seno, la función arco seno es impar, ya que se verifica $ \arcsin(-x) = -\arcsin(x) $. Con los valores de esta tabla se puede trazar un gráfico aproximado como el de la figura~\ref{fig:27a}. Nótese la simetría respecto a la recta $ y = x $ entre el segmento de seno y su inversa.
%
%\figurex{Ejercicio 27.a}{4.6}{../img/guide_01/ex_27a.png}{fig:27a}
%
%Aplicando este mismo procedimiento a $ h(x) = \cos(x) $, el primer tramo donde resulta inyectiva corresponde a $x \in [0, \pi]$. La imagen de ese tramo es $[-1, 1]$, por lo que la función arco coseno asociada a esa rama, que de nuevo es la canónica, tendrá como dominio $[-1, 1]$ y como imagen $[0, \pi]$. Tomando valores de nuevo, se puede aproximar un gráfico como el de la figura~\ref{fig:27b}.
%
%\figurex{Ejercicio 27.b}{5}{../img/guide_01/ex_27b.png}{fig:27b}
%
%\subsectionx{27.a}
%
%Asumiendo que la función arco seno considerada es la canónica, existe una sola solución a esta ecuación y se obtiene aplicando la función seno miembro a miembro.
%
%\begin{equation}
%\sin( \arcsin(x) ) = \sin\left( \frac{\pi}{4} \right) \Rightarrow \hresult{27.a}{ x = \frac{\sqrt{2}}{2} }
%\end{equation}
%
%\subsectionx{27.b}
%
...
%\sectionx{28}
%
%\textbf{Represente las siguientes funciones:}
%
%\begin{enumerate}[(a)]
%
%\bfseries
...
%\subsectionx{28.a}
%
%Es la función módulo desplazada 5 unidades hacia la izquierda.
%
%\figurex{Ejercicio 28.a}{1.9}{../img/guide_01/ex_28a.png}{fig:28a}
%
%\subsectionx{28.b}
%
%Es la función módulo desplazada 5 unidades hacia la derecha.
%
%\figurex{Ejercicio 28.b}{1.9}{../img/guide_01/ex_28b.png}{fig:28b}
%
%\subsectionx{28.c}
%
%De manera generar, aplicar la función módulo a una función cualquiera hace que sus partes negativas se vuelvan positivas. Gráficamente, las partes de la curva que estén bajo el eje $ x $ serán reflejadas respecto al mismo. En el caso del seno, el mismo es negativo en los infinitos intervalos $ \ldots \cup (\pi, 2\pi) \cup (3\pi, 4\pi) \cup \ldots = \bigcup\limits_{k=-\infty}^{+\infty} ((2k-1)\pi, 2k\pi) $. En otras palabras, todos los lóbulos negativos de la curva seno serán invertidos respecto al eje $x$.
%
%\figurex{Ejercicio 28.c}{3.3}{../img/guide_01/ex_28c.png}{fig:28c}
%
%\subsectionx{28.d}
%
%Aplicar módulo a la función exponencial no tiene ningún efecto, ya que no toma valores negativos. Es exactamente la misma curva que $y = e^x$.
%
%\figurex{Ejercicio 28.d}{2}{../img/guide_01/ex_28d.png}{fig:28d}
%
%\sectionx{29}
%
%\begin{enumerate}[(a)]
...
%\bfseries
%
%\item Dada la función $ f(x) = \left\{ \begin{array}{ll}
%x + 2 & \text{ si } x \leq -1 \\
%-x & \text{ si } -1 < x \leq 1 \\
%3x-4 \text{ si } 1 < x
%\end{array} \right. $, calcule $ f(-3) $, $ f(1) $ y $ f(4) $. Determine para qué valores de $ y $ la ecuación $ f(x) = y $ tiene solución. ¿Cuándo es única?
%
%\item Ídem para la función $ f(x) = \left\{ \begin{array}{ll}
%3x+1 & \text{ si } x < -4 \\
%\frac{1}{x+2} & \text{ si } x \geq -4
%\end{array} \right. $
%
%\end{enumerate}
%
...
%\subsectionx{29.a}
%
%Para $x = -3$, $ f(x) = x+2 \Rightarrow f(-3) = -3+2 \Rightarrow \hresult{29.a.1}{ f(-3) = -1 } $
%
%Para $x = 1$, $ f(x) = -x \Rightarrow f(1) = -(1) \Rightarrow \hresult{29.a.2}{ f(1) = -1 } $
%
%Para $x = 4$, $ f(x) = 3x-4 \Rightarrow f(4) = 3 \cdot 4 - 4 \Rightarrow \hresult{29.a.3}{ f(4) = 8 } $
%
%A la hora de analizar si $ f(x) = y $ tiene solución, es de utilidad calcular el conjunto imagen de $ f $. En este caso en particular, graficar $ f $ es un camino bastante directo.
%
%\figurex{Ejercicio 29.a}{4}{../img/guide_01/ex_29a.png}{fig:29a}
%
%En la figura~\ref{fig:29a} se observa que $ \mathop{\text{Img}}(f) = \mathbb{R}$. Por ende,
%
%\begin{equation}
...
%\sectionx{P2}
%
%\textbf{ Se definen $ \cosh(x) = \frac{e^x + e^{-x}}{2} $ y $ \sinh(x) = \frac{e^x - e^{-x}}{2} $ . Probar que:}
%
%\begin{enumerate}[(a)]
%
%\bfseries
...
%
%\item Los gráficos de ambas funciones no se cortan.
%
%\end{enumerate}
%
%\hrule
...
%& \frac{1}{4} (e^{2x} + 2 e^x e^{-x} + e^{-2x}) - \frac{1}{4} (e^{2x} - 2 e^x e^{-x} + e^{-2x}) = \\
%& \cancel{ \frac{1}{4} e^{2x} } + \frac{1}{2} + \cancel{\frac{1}{4} e^{-2x} } - \cancel{\frac{1}{4} e^{2x} } + \frac{1}{2} - \cancel{\frac{1}{4} e^{-2x} } = 1
%\end{align}
%\end{subequations}
%
%\subsectionx{P2.b}
%
%Para que los gráficos de $ \cosh(x) $ y $ \sinh(x) $ se corten, debe existir al menos un valor de $ x $ para el cual se satisfaga:
%
%\begin{subequations}
%\begin{align}
%& \cosh(x) = \sinh(x) \Leftrightarrow \\
%& \frac{e^x + e^{-x}}{2} = \frac{e^x - e^{-x}}{2} \Leftrightarrow \\
%& e^{-x} = -e^{-x} \Leftrightarrow \\
%& 2 e^{-x} = 0 \Leftrightarrow \\
%& e^{-x} = 0
%\end{align}
%\end{subequations}
%
%La exponencial decreciente, al igual que la creciente, no se anula para ningún número real. Por lo tanto, los gráficos de las funciones jamás se cortan.
%
%\sectionx{P3}
%
%\textbf{ Un cántaro vacío con capacidad para 20 litros pesa 2550 gramos. }
%
%\begin{enumerate}[(a)]
%
%\bfseries
%
%\item Represente la función que da el peso total del cántaro en función de la cantidad de agua, en litros, que contiene. Halle su fórmula. ¿Cuál es el dominio?
%
%\item Si disponemos de 3 litros de mercurio, cuyo peso total es 40,8 kg, repita el ítem anterior sustituyendo el agua por el mercurio. 
%
%\item Si se representan las funciones de (a) y (b) en los mismos ejes, ¿qué significa el punto de intersección?
%
%\item ¿Es cierto que a doble cantidad de líquido corresponde doble peso total?
%
%\end{enumerate}
%
%\hrule
%\vspace{1em}
%
%En primer lugar, es incorrecto decir que el cántaro pesa 2550 gramos. El peso es una fuerza, y su valor depende de la masa del objeto y la aceleración de la gravedad. La fuerza es una magnitud vectorial y su intensidad se mide en Newtons, o kilogramos fuerza; la masa es una unidad escalar y se mide en gramos. Son dos magnitudes diferentes. Como la aceleración de la gravedad en la superficie terrestre es, a fines prácticos, una constante, se suele aceptar este abuso de notación. Para ser correctos en términos físicos, se asumirá que el cántaro pesa 2550 gramos fuerza en la superficie terrestre.
%
%\sectionx{P3.a}
%
%Sean:
...
%\begin{itemize}
%
%\item $ x $: cantidad de agua en el cántaro. Unidad: litros.
%
%\item $ f(x) $: peso del cántaro con $ x $ litros de agua en su interior. Unidad: gramos fuerza.
%
%\end{itemize}
%
%Con estas definiciones, y asumiendo condiciones normales de presión y temperatura, la densidad del agua es tal que 1 cc de agua pesa 1 gramo fuerza. Siendo 1 litro igual a 1000 cc, 1 litro de agua pesa 1000 gramos fuerza. Por lo tanto:
%
%\begin{equation}
%\hresult{P3.a}{ f(x) = 2550 + 1000 \cdot x, \mathop{\text{Dom}}(f) = [0, 20] }
%\end{equation}
%
%\sectionx{P3.b}
%
...
%\begin{itemize}
%
%\item $ x $: cantidad de mercurio en el cántaro. Unidad: litros.
%
%\item $ g(x) $: peso del cántaro con $ x $ litros de mercurio en su interior. Unidad: gramos fuerza.
%
%\end{itemize}
%
%Si 3 litros de mercurio pesan 40,8 kg fuerza, entonces 1 litro pesa 40,8/3 = 13,6 kg fuerza = 13600 gramos fuerza. Resulta entonces:
%
%\begin{equation}
%\hresult{P3.b}{ g(x) = 2550 + 13600 \cdot x, \mathop{\text{Dom}}(f) = [0, 20] }
%\end{equation}
%
%\sectionx{P3.c}
%
%Representa el punto $(x, y)$ en donde poner $ x $ litros de agua en el cántaro hace que pese lo mismo que poniendo $ x $ litros de mercurio. Como el agua y el mercurio tienen diferentes densidades, eso sólo puede ocurrir para $ x = 0 $.
%
%\sectionx{P3.d}
%
%No, porque siempre se suma el peso del cántaro y eso rompe la proporción. Algebraicamente, para cualquier función lineal $ f(x) = ax +b $:
%
%\begin{equation}
%\frac{f(2x)}{f(x)} = \frac{a 2 x + b}{ax + b}
%\end{equation}
%
%Esto sólo vale 2 para el caso $ b = 0 $.
%
%\sectionx{P4}
%
%\textbf{Si $ f(n) = \frac{2^{3n}}{4n+1} $, calcular $ \frac{f(n+1)}{f(n)} $ y obtener su valor numérico para $ n = 1, 2, 3, 4 $ y $ 5 $. }
%
%\vspace{1em}
%\hrule
%\vspace{1em}
%
%Evaluando de manera directa:
%
%\begin{subequations}
%\begin{align}
%& \frac{f(n+1)}{f(n)} = \frac{2^{3(n+1)}}{4 (n+1) + 1} : \frac{2^{3n}}{4n+1} = \\
%& \frac{ \cancel{2^{3n}} 2^3}{4n+5} : \frac{ \cancel{2^{3n}} }{4n+1} = \\
%& \frac{8 (4n+1)}{(4n+5)} \Rightarrow \\
%& \hresult{P4.1}{ \frac{f(n+1)}{f(n)} = \frac{32n+8}{4n+5} }
%\end{align}
%\end{subequations}
%
%Sea $ g(n) = \frac{f(n+1)}{f(n)} $. Dando valores a $ n $ en la expresión obtenida,
%
%\begin{subequations}
%\begin{align}
%g(1) &= \frac{40}{9} \approx 4,4444 \\
%g(2) &= \frac{72}{13} \approx 5,5385 \\
%g(3) &= \frac{104}{17} \approx 6,1176 \\
%g(4) &= \frac{136}{21} \approx 6,4762 \\
%g(5) &= \frac{168}{25} = 6,72
%\end{align}
%\end{subequations}
