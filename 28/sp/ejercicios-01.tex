...
\figurex{Ejercicio 14.a}{1}{../img/guide_01/ex_14a.png}{fig:14a}

\subsection*{14.b}
\label{subsec:14.b}
\addcontentsline{toc}{subsection}{\nameref{subsec:14.b}}

Éste es el gráfico anterior desplazado horizontalmente, 2 unidades hacia la derecha. En lugar de estar centrado en $(0,0)$, pasa a estar centrado en $(2,0)$. Fuera de eso, la curva es igual.

\figurex{Ejercicio 14.b}{1}{../img/guide_01/ex_14b.png}{fig:14b}

\subsection*{14.c}
\label{subsec:14.c}
\addcontentsline{toc}{subsection}{\nameref{subsec:14.c}}

Nuevamente, este gráfico puede verse como una transformación de $f(x) = x^3$. En este caso, un desplazamiento vertical, de 1 unidad hacia abajo. El origen pasa de estar en $(0, 0)$ a estar en $(0,-1)$. Como no hay escalado, fuera de eso la curva es igual.

\figurexnp{Ejercicio 14.c}{1}{../img/guide_01/ex_14c.png}{fig:14c}

\subsection*{14.d}
\label{subsec:14.d}
\addcontentsline{toc}{subsection}{\nameref{subsec:14.d}}

La función cuártica es una cuadrática que crece mucho más rápido. También es par, así que es simétrica respecto al eje $y$. Con evaluar en $0, 1, -1, 2$ y $-2$ es suficiente para ver cómo se comporta.

Por otro lado, para valores menores a 1, tiende a cero más bruscamente que una cuadrática, lo que da un efecto de planchado en el intervalo $(-1, 1)$.

\newpage

\figurexnp{Ejercicio 14.d}{1}{../img/guide_01/ex_14d.png}{fig:14d}
