...
\textbf{A partir de los gráficos de $ g(x) = \sin(x) $ y $ h(x) = \cos(x) $, haga el gráfico de: }
...
\item $ f(x) = \sin\left( x + \frac{\pi}{2} \right) $
...
Ahora sólo hay un desplazamiento horizontal de $\pi$ unidades hacia la izquierda. Nótese que esto coincide con el gráfico del coseno, lo cual es coherente con la conocida identidad $ \cos(x) = \sin\left(x + \frac{\pi}{2} \right) $.
