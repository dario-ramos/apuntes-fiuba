...
\begin{figure}[ht]
\caption{Hipérbolas}
\includegraphics[scale=0.8]{../img/module_01/hyperbolas.png} 
\centering
...
\includegraphics[scale=0.8]{../img/module_01/point_plane_distance.png} 
\centering
...
\includegraphics[scale=0.8]{../img/module_01/point_line_distance.png} 
\centering
...
\includegraphics[scale=1.0]{../img/module_01/polar_coordinates.png}
\centering
\label{fig:polares}
\end{figure}
...
\includegraphics[scale=0.5]{../img/module_02/hyperboloid1.png} 
\centering
...
\includegraphics[scale=0.5]{../img/module_02/hyperboloid2.png} 
\centering
...
\includegraphics[scale=0.3]{../img/module_02/hparaboloid.png} 
\centering
...
\includegraphics[scale=0.75]{../img/module_03/limit.png} 
\centering
\label{fig:limite}
\end{figure}
...
\includegraphics[scale=0.75]{../img/module_03/limit_via_curve.png}
\centering
...
\includegraphics[scale=0.75]{../img/module_04/directional_deriv.png}
...
\includegraphics[scale=0.75]{../img/module_04/dir_deriv_mapping.png}
...
Sea $f$ un campo escalar en $\Bbb R^2$, diferenciable en el punto $P_0$. Por los resultados ya vistos en cuanto a diferenciabilidad, debe cumplirse que:
...
\centering
\includegraphics[scale=0.6]{../img/module_04/graphical_interp.png} 
...
\centering
\includegraphics[scale=0.6]{../img/module_04/chain_rule.png} 
...
\includegraphics[scale=0.7]{img/module_04/visual_chain_rule.png} 
\centering
\label{fig:rc2}
\end{figure}
...
\subsection{Parametrización a velocidad constante para curvas}

Dada una curva $C$ en el espacio, es de interés hallar una parametrización de velocidad constante. Vale decir, hallar:

\begin{equation}
r(t) = (x_1(t), x_2(t), \ldots, x_n(t))
\end{equation}

Esta parametrización $r(t)$ debe seguir la trayectoria de $C$ y a la vez cumplir que la norma del vector velocidad sea constante punto a punto, vale decir $||r'(t)|| = k, k \in \Bbb R$. De manera general, si la curva comienza en $t = a$, la distancia total recorrida en el tiempo transcurrido entre $a$ y $t$ es:

\begin{equation}
s(t) = \int_{a}^t ||r'(\tau)|| \mathop{d\tau}
\end{equation}

Para el caso particular en que la velocidad es de módulo constante, la distancia es el producto del módulo de la velocidad por el tiempo: $s(t) = v t$. Expandiendo la norma de $r'(t)$, resulta, para el caso bidimensional (esto es fácilmente extensible a $n$ dimensiones):
...
\includegraphics[scale=1]{../img/module_05/cauchy_dini.png} 
\centering
\label{fig:tcd}
\end{figure}
...
\includegraphics[scale=0.6]{../img/module_06/type1.png} 
\label{fig:exce01}
\end{minipage}
...
\includegraphics[scale=0.6]{../img/module_06/type2.png} 
\centering
\label{fig:exce02}
\end{figure}
...
\includegraphics[scale=0.6]{../img/module_06/type3.png} 
\centering
\label{fig:exce03}
\end{figure}
...
\includegraphics[scale=0.8]{../img/module_06/diagonal_det.png} 
\centering
\label{fig:detdiag}
\end{figure}
...
\centering
\includegraphics[scale=0.6]{../img/module_07/line_integral.png} 
\end{figure}
...
\includegraphics[scale=0.7]{../img/module_07/reparam.png}
\label{fig:reparam}
\end{figure}
...
\centering
\caption{Lema}
\includegraphics[scale=0.75]{../img/module_07/conserv_fields.png}
\end{figure}
...
\centering
\caption{Ejemplo}
\includegraphics[scale=1]{../img/module_07/cf_example.png}
\label{fig:ccej}
\end{figure}
...
\includegraphics[scale=0.8]{img/module_07/mult_integ.png}
\label{fig:intmul}
\end{figure}
...
\includegraphics[scale=0.75]{../img/module_07/volume_below_surf.png}
...
\includegraphics[scale=0.75]{../img/module_07/mi_d1.png}
\label{fig:d1}
\end{figure}
...
\includegraphics[scale=0.75]{../img/module_07/mi_d2.png}
\label{fig:d2}
\end{figure}
...
\includegraphics[scale=0.75]{../img/module_07/mi_example.png}
\label{fig:coi}
\end{figure}
...
\includegraphics[scale=0.6]{../img/module_07/triple_integral.png}
\label{fig:itv}
\end{figure}
...
\includegraphics[scale=0.8]{../img/module_07/polar_scale_factor.png}
\label{fig:cp}
\end{figure}
...
\includegraphics[scale=0.8]{../img/module_07/cart2pol.png}
\label{fig:polacart}
\end{figure}
...
\includegraphics[scale=0.8]{../img/module_07/cylindrical_coords.png}
\label{fig:ccil}
\end{figure}
...
\includegraphics[scale=0.8]{../img/module_07/spherical_coords.png}
\label{fig:cesf}
\end{figure}
...
\includegraphics[scale=0.8]{../img/module_07/surface_area.png}
\label{fig:asuf}
\end{figure}
...
\includegraphics[scale=0.8]{img/module_07/surface_projection.png}
\label{fig:isi}
\end{figure}
...
\includegraphics[scale=0.8]{../img/module_07/implicit_surf_area.png}
\label{fig:isiej}
\end{figure}
...
\includegraphics[scale=0.6]{../img/module_07/orientable_surf.png}
\label{fig:son}
\end{figure}
...
\includegraphics[scale=0.85]{../img/module_08/green.png}
\label{fig:green}
\end{figure}
...
\includegraphics[scale=0.85]{../img/module_08/green_conn_region.png}
\label{fig:greenrc}
\end{figure}
...
Esbozo de demostración: considérese la curva $\gamma_1$, que conecta $C_1$ y $C_2$ en la figura~\ref{fig:greendemo}.

\begin{figure}[ht]
\centering
\caption{Green en región conexa}
\includegraphics[scale=1]{../img/module_08/green_cr_demo.png}
\label{fig:greendemo}
\end{figure}
...
\includegraphics[scale=1]{../img/module_08/green_holes.png}
...
\includegraphics[scale=0.5]{../img/module_08/stokes.png}
\label{fig:stokes}
\end{figure}
...
\includegraphics[scale=0.7]{../img/module_08/stokes_closed_surf.png}
\label{fig:stokes2}
\end{figure}
...
\includegraphics[scale=0.7]{../img/module_08/stokes_example.png}
\label{fig:stokesex}
\end{figure}
...
\includegraphics[scale=0.7]{../img/module_08/gauss.png}
\label{fig:gauss}
\end{figure}
