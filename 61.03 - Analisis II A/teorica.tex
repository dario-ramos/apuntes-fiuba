...
Sea $f$ un campo escalar y $P_0$ un punto interior del dominio de $f$. Sean $\overrightarrow{v}$ un vector cualquiera en $\Bbb R^n$, y $h$ un escalar tal que $P_0 + h \overrightarrow{v}$ pertenezca a un entorno de $P_0$ incluido en el dominio. Gráficamente:
...
%\includegraphics[scale=1.0]{img/teo_fig004_deriv_direcc.png} 
%\centering
...
% TODO Make this work
%\includegraphics[scale=1]{img/teo_fig005_deriv_direcc.png} 
