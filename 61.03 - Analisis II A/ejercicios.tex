...
& \frac{\partial f}{\partial x}(0, 0) = \lim_{h \rightarrow 0} \frac{f(0+h, 0)-f(0)}{h} = \lim_{h \rightarrow 0} \frac{\frac{2h^3}{h^2}}{h} = \lim_{h \rightarrow 0} \frac{2h}{h} = 2 \\
& \frac{\partial f}{\partial y}(0, 0) = \lim_{h \rightarrow 0} \frac{f(0, 0+h)-f(0)}{h} = \lim_{h \rightarrow 0} \frac{\frac{-h^3}{3h^2}}{h} = \lim_{h \rightarrow 0} \frac{-\frac{1}{3}h}{h} = -\frac{1}{3}
\end{align}
\end{subequations}
