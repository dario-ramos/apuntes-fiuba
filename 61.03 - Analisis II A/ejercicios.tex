...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=2.5.c. Dominio ]
{ \mathop{Dom}(f) = \Bbb R^2 }
\end{equation}
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=2.5.d. Continuidad ]
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=2.5.w. Dominio ]
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=2.5.e. Continuidad ]
{ f \in C^0(\mathop{Dom(f)}) }
\end{equation}
