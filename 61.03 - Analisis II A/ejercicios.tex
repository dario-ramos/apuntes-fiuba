...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=1.16.e) $A^{\circ}$]
{ A^{\circ} = \emptyset }
\end{equation}
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=1.16.h) Interior]
{ A^{\circ} = A }
\end{equation}
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=1.16.h) Frontera]
{
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange,title=1.16.i) Interior]
{ A^{\circ} = A }
\end{equation}
