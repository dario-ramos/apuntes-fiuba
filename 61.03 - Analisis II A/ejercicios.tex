...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange, title=16-a: Frontera]
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange, title=16-b: Frontera]
...
\begin{equation}
\tcboxmath[colback=orange!25!white,colframe=orange, title=16-c: Frontera]
{ A^{\circ} = (0,0) \cup \{ (x, y) \in \Bbb R^2 / x = 0 \wedge y < 0 \} \cup \{ (x, y) \in \Bbb R^2 / y = 0 \wedge x > 0 \} }
\end{equation}
